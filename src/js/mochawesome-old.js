...
/* global Chart */
/* global _ */
+function ($, Chart, _, React, ReactDOM) {
  'use strict';
  ...
  var rawData = JSON.parse(bodyEl.getAttribute('data-raw'));
  bodyEl.removeAttribute('data-raw');

  var MochawesomeReport = React.createClass({
    render: function () {
      return <div>{ this.props.data.reportTitle }</div>;
    }
  });

  ReactDOM.render(
    <MochawesomeReport data={ rawData }/>,
    document.getElementById('react')
  );
  
}(jQuery, Chart, _, React, ReactDOM);