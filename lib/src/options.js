...
const yargsOptions = {
  ...
  filter: {
    default: 'all',
    describe: 'A comma separated list of filters to be applied by default',
    string: true
  }
};
...
function getBaseConfig() {
  ...
  Object.keys(yargsOptions).forEach(optKey => {
    ...
    if (Array.isArray(aliases) && aliases.length) {
      ...
      aliases.forEach(alias => assignVal(alias, defaultVal));
    } else {
...
module.exports = { getYargsOptions, getBaseConfig };
